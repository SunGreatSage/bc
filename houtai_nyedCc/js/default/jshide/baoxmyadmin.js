...
function bao() {
	...
	$.ajax({
		...
		success: function(mm) {
			...
			m = mm['zbao'];
			str += "<tr><th colspan=9 class='bt'>总报表</th></tr><tr><th>公司</th><th>注数</th><th>会员下注</th><th>会员退水</th><th>贡献率</th><th>占比</th><th>公司占成</th><th>退水</th><th>公司收付</th></tr>";
			for (i = 0; i < zbl; i++) {
			...
			for (i = 0; i < gbl; i++) {
				...
				str += "<tr class='" + m[i][0]['style'] + "tb'><td colspan=9 class='bt' >" + m[i][0]['gname'] + "</td></tr><tr><th>公司</th><th>注数</th><th>会员下注</th><th>会员退水</th><th>贡献率</th><th>占比</th><th>公司占成</th><th>退水</th><th>公司收付</th></tr>";
				for (j = 0; j < ul; j++) {
...
function getbao() {
	...
	$.ajax({
		...
		success: function(m) {
			...
			var zshui = 0;
			var zyk = 0;
			str += "<tr><th>公司</th><th>注数</th><th>会员下注</th><th>会员退水</th><TH>贡献率</TH><TH>占比</TH><th>公司占成</th><th>退水</th><th>公司收付</th></tr>";
			var zuserje = 0;
			var zuserpoints = 0;
			for (i = 0; i < ml; i++) {
				str += "<tr>";
