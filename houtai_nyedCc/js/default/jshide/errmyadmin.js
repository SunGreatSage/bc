...
/*	if (layer < 8) {
	...
	$(".nowtb tr:eq(0)").append("<th><strong style='color: red' >公司金额</strong></th>");
...
function getnow() {
	...
	$.ajax({
		...
		success: function(m) {
			var ml = m['tz'].length;
			if (ml == 0)
		    $(".nowtb").append("<tr><td height='28' colspan='17' align='center'><marquee align='middle' behavior='alternate' style='width: 100%;'><font class='font_r'>查无任何资料</font></marquee></td></tr>");
		     return;	 
			var str = '';
			for (i = 0; i < ml; i++) {
				str += "<tbody id='listBody'><tr class='c";
			...
			/*$(".nowtb").prepend("<tr style='display: none;' ><td colspan=5><a href='javascript:void(0)' class='delselect' >删除选中</a>&nbsp;&nbsp;<a href='javascript:void(0)' class='delall' >删除全部</a></td><td colspan=37>" + m['page'] + "</td></tr>");*/
			$(".nowtb").append(str);
