function myready() {
	...
	//	var logincode = $(".logincode").prop('checked') ? 1 : 0;
		...
		str = "&autodellogin="+autodellogin+"&autodellogintime="+autodellogintime+"&autodeledit="+autodeledit+"&autodeledittime="+autodeledittime+"&autodelpl="+autodelpl+"&autodelpltime="+autodelpltime+"&psize="+psize+"&psize1="+psize1+"&psize2="+psize2+"&psize3="+psize3+"&psize5="+psize5;
        if(!confirm("是否保存参数设置"))	return false;
