function myready(){
	...
	frame.window.location.href = mulu + "make.php?xtype=show&gids="+$("#lotterys a.selected").attr('gid');
	//$(".ui-dialog" ).draggable();
	$(".sendtb").draggable();
	...
	$(".pk_con li", window.parent.document).on("click",
    function() {
	...
	$(".top_menu a").click(function(){
	    ...
	    $(".sub div li").click(function(){
			var index = $(this).index();
			frame.window.location.href = mulu + "make.php?xtype=show&gids="+$("#lotterys a.selected").attr('gid')+"&menu="+index;
		});
		 if (url != 'logout') {
	...
	$(".spritearrow").click(function() {
        ...
        t;
        i == "spritearrow arrowup" ? ($(this).removeClass("arrowup"), $(this).addClass("arrowdown"), $(".top_w").slideUp(500), $(".logo").fadeOut(500), $(".header").animate({
            height: "73px"
        },
        500), $(".middle-content").animate({
            top: "73px"
        },
        500), t = document.getElementById("left_con"), n || (n = t.style.maxHeight.replace("px", "") - 0), $("#left_con").animate({
            maxHeight: n + 65 + "px"
        },
        500)) : ($(this).addClass("arrowup"), $(this).removeClass("arrowdown"), $(".top_w").slideDown(500), $(".logo").fadeIn(500), $(".header").animate({
            height: "138px"
        },
        500), $("#middle-content").animate({
            top: "138px"
        },
        500), n || (t = document.getElementById("left_con"), n = t.style.maxHeight.replace("px", "") - 0), $("#left_con").animate({
            maxHeight: n + "px"
        },
        500))
    })
	...
	$("#lotterys a.g").unbind('click');
	 $("#lotterys a.g").click(function(){
		...
		// console.log($(this).attr('gid'));
		 if($(this).attr('gid')==100){ 
			$("#lotStyle").attr("href", "/default/css/member/yellow/skinbd.min.css");
			$(".left_btn").attr("href", "https://6hch.com");
			}else if($(this).attr('gid')==200){
			$("#lotStyle").attr("href", "/default/css/member/skinbd.min.css");
			$(".left_btn").attr("href", "https://00853lhc.com");
			}else {
			$("#lotStyle").attr("href", "/default/css/member/skinbd.min.css");
			$(".left_btn").attr("href", "https://macao-jc.cc");
    	 }
		 $("#lotterys a").removeClass("selected");
