	...
	$.ajax({
		...
		success:function(m){			
			...
			if(layer==6){
			   ...
			   str += "<tr><th rowspan=2>大股东</th><th rowspan=2>笔数</th><th rowspan=2>下注总额</th><th rowspan=2>退水</th><th rowspan=2>会员盈亏</th><td colspan=3 class=b1>大股东</td><td colspan=6 class=b2>公司</td><td colspan=3  class=b3>公司</td></tr><tr><th>大股东金额</th><th>退水</th><th>盈亏</th><th>占成</th><th>退水</th><th>占成盈亏</th><th>赚赔率差</th><th>赚水</th><th>总盈亏</th><th>公司金额</th><th>退水</th><th>盈亏</th></tr>";
			}else if(layer==2){
