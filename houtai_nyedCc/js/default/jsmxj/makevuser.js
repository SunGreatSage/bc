...
function myready() {
    ...
    $(".gamelist span").click(function() {
       window.location.href = "/Mobile/Index?xtype=show&type=lib&gids=" + $(this).attr("gid");
    });
    $(".uq_icon").click(function() {
        if($(".tzbody:visible").length==1){
            if ($(".edu").hasClass("bfHvQP")) {
               $(".edu").removeClass("bfHvQP").addClass("jdQhcW");
			   $(".uq_icon").removeClass("uq_icon").addClass("ico_down");
            } else {
               $(".edu").removeClass("jdQhcW").addClass("bfHvQP");
			   $(".ico_down").removeClass("ico_down").addClass("uq_icon");
            }
        }else{
    ...
    $(".menuplay a:eq(1)").addClass("lrm_back");
 ...
 /*   $(".clmenu").click(function(){
    ...
    $(".menulist a").click(function() {
	 ...
	 $(".Unsettlement").click(function() {
           window.location.href = "/Mobile/UnCheckBetting";
    });
	$(".Closed").click(function() {
           window.location.href = "/Mobile/CheckBetting";
    });

    $(".tz .editje").click(function(){
         $(".fastje").show();
    });
    $(".tz .quick_box a").click(function(){
		if ($(this).html()!= '设置') {
        $(".tz .je").val($(this).html());
        $.cookie('yusheje',$(this).html());
		$(".quick_box").hide();
        totalje();
		}
    });
    ...
    $(".tz .jeqr").click(function(){
          ...
          if(isNaN($(".tz .jeqr").attr('v')) || Number($(".tz .jeqr").attr('v'))<1){
			    if($(".play.qiuselect").length==0){
					$(".weui-dialog__bd").html("请点击并选择下注内容,或检查下注内容是否正确！");
				}else{	
				 $(".weui-dialog__bd").html("投注金额最低为"+minje);
				 }
             $(".errmsgwm").show();
             return false;
          }
    ...
    $(".lastzd .lb_back").click(function(){
		 $("#myModal_1").show();
		  ...
		  $(".lastzd").removeClass("efUsXr").addClass("iJamhB");
		   $(".kzclass").removeClass('kzclasson');
		  });
   $(".ico_back").click(function(){
		 $("#myModal_1").show();
		  $(".tz").show();
		   $(".tongjidiv").hide();
		  });
	...
	$(".setABCD").click(function(){
		var pk = $(this).attr("pk");
                $.ajax({
                    ...
                    data:"xtype=setdefaultpan&pan="+pk,
                    success:function(m){
                        if(Number(m)==1){
		                     $("#weui-actionsheet").removeClass("weui-actionsheet_toggle");
		                     $(".zhao").removeClass("OSUUp").addClass("ivfTfC");
                            $(".menulist.efUsXr").removeClass("efUsXr").addClass("iJamhB");
						  $(".weui-dialog__bd").html("设置成功,默认盘口:"+pk+"");
            ...
            if (bname == "两面" || bname=="大小骰宝") {
                if (fenlei == 107) {
                    ...
                    for (i = 0; i < ml; i++) {
                        if(m[i]['sname']=="冠亚和") continue;
                        if (tmpsid != m[i]['sid']) {
                            if (tmpsid != 0) str += "</div></div></div></div>";
               ...
               for(j=0;j<5;j++){
                ...
                str += "</div></div></div></div>";
                    ...
                    str += "</div></div></div></div>";
            }else if(bname == '快捷' && fenlei == 100){
                  str += rhtmlskj('特碼');
				  str += '<div class="kzjs">';
				  str += '<a class="kzclass" kz="1"><span style="color: red">红波</span></a><a class="kzclass" kz="2"><span style="color: blue">蓝波</span></a><a class="kzclass" kz="3"><span style="color: green">绿波</span></a>';
                  str += '<a class="kzclass" kz="4"><span style="color: red">红大</span></a><a class="kzclass" kz="5"><span style="color: blue">蓝大</span></a><a class="kzclass" kz="6"><span style="color: green">绿大</span></a>';
				  str += '<a class="kzclass" kz="7"><span style="color: red">红小</span></a><a class="kzclass" kz="8"><span style="color: blue">蓝小</span></a><a class="kzclass" kz="9"><span style="color: green">绿小</span></a>';
				  str += '<a class="kzclass" kz="10"><span style="color: red">红单</span></a><a class="kzclass" kz="11"><span style="color: blue">蓝单</span></a><a class="kzclass" kz="12"><span style="color: green">绿单</span></a>';
				  str += '<a class="kzclass" kz="13"><span style="color: red">红双</span></a><a class="kzclass" kz="14"><span style="color: blue">蓝双</span></a><a class="kzclass" kz="15"><span style="color: green">绿双</span></a>';
				  str += '<a class="kzclass" kz="16"><span>大号</span></a><a class="kzclass" kz="17"><span>小号</span></a><a class="kzclass" kz="18"><span>单号</span></a>';
				  str += '<a class="kzclass" kz="19"><span>双号</span></a><a class="kzclass" kz="20"><span>大单</span></a><a class="kzclass" kz="21"><span>大双</span></a>';
				  str += '<a class="kzclass" kz="22"><span>小单</span></a><a class="kzclass" kz="23"><span>小双</span></a><a class="kzclass" kz="24"><span>合单</span></a>';
				  str += '<a class="kzclass" kz="25"><span>合双</span></a><a class="kzclass" kz="26"><span style="color: #CC6724">鼠</span></a><a class="kzclass" kz="27"><span style="color: #CC6724">牛</span></a>';
				  str += '<a class="kzclass" kz="28"><span style="color: #CC6724">虎</span></a><a class="kzclass" kz="29"><span style="color: #CC6724">兔</span></a><a class="kzclass" kz="30"><span style="color: #CC6724">龙</span></a>';
				  str += '<a class="kzclass" kz="31"><span style="color: #CC6724">蛇</span></a><a class="kzclass" kz="32"><span style="color: #CC6724">马</span></a><a class="kzclass" kz="33"><span style="color: #CC6724">羊</span></a>';
				  str += '<a class="kzclass" kz="34"><span style="color: #CC6724">猴</span></a><a class="kzclass" kz="35"><span style="color: #CC6724">鸡</span></a><a class="kzclass" kz="36"><span style="color: #CC6724">狗</span></a>';
				  str += '<a class="kzclass" kz="37"><span style="color: #CC6724">猪</span></a>';
                  str += '</div>';
				 for (i = 0; i <ml; i++) {
                        if(isNaN(m[i]['name'])) continue;
                        str += rhtmlbkj(m[i]);
                    ...
                    for (i = 0; i <ml; i++) {
                        if(tmpcid!=m[i]['cid']){
                           if(tmpcid!=0) str += "</div></div></div></div>";
...
function addfunc(duo){
    ...
    if(duo==1){
        ...
        $(".dds").click(function(){
		    ...
		    if (bname == '特碼' | bname.substr(2, 1) == '特' | bname == '快捷') {
				if(bname == '快捷'){
                    $(".SecGame option:eq(0)").html("特碼A");
                    $(".SecGame option:eq(1)").html("特碼B");
				 } else {
					$(".SecGame option:eq(0)").html(bname + "A");
                    $(".SecGame option:eq(1)").html(bname + "B");
                }
			   $(".game_se:eq(0)").show();
			   $(".namexm:eq(0)").hide(); 
				} else {
         ...
         $(".play").click(function(){
		    ...
		    $(".kzjs a.kzclass").click(function() {
				var kz = $(this).attr("kz");
				var kzn = sma[kz];
				if($(this).hasClass("kzclasson")){
				$(".bcn_number_type .play").each(function(i) {
					var pname = Number($(this).attr("mname"));
					var pid = $(this).attr("pid");
					if (i <= 48 & $.inArray(pname, kzn) != -1) {
							$(".bcn_number_type a.p" + pid).removeClass("qiuselect");
						}
					var zs = $(".play.qiuselect").length;
					$("#myModal_1").html(""+zs+"注");
					});
					$(this).removeClass('kzclasson');
				}else{
					$(".bcn_number_type .play").each(function(i) {
					var pname = Number($(this).attr("mname"));
					var pid = $(this).attr("pid");
					if (i <= 48 & $.inArray(pname, kzn) != -1) {
							$(".bcn_number_type a.p" + pid).addClass("qiuselect");
						}
					var zs = $(".play.qiuselect").length;
					$("#myModal_1").html(""+zs+"注");
					});
					$(this).addClass('kzclasson');
					}
             });
 
		
		 
		 $(".k_box input[type='text']").each(function(){
             
         });
		 
		$(".SecGame").change(function(){
        lib();
    ...
    $("a.bt_icon.open").click(function(){
        ...
        if(obj.css('display')==='none'){
			 $(".bt_icon.open").css({transform: "rotate(0deg)"});
        }else{
            $(".bt_icon.open").css({transform: "rotate(180deg)"});; 			 
        }        
		obj.slideToggle();	
    });
...
function exe() {
    ...
    for (i = 0; i < pl; i++) {
        ...
        if (Number(play[i]['je']) > maxje) {
            $(".weui-dialog__bd").html("[" + play[i]['name'] + "]单注最大金额" + maxje);
            $(".errmsgwm").show();
            return false;
        }
        if (Number(play[i]['je']) < minje) {
            $(".weui-dialog__bd").html("[" + play[i]['name'] + "]单注最小金额" + minje);
            $(".errmsgwm").show();
            return false;
        }
    ...
    if(zje<1){
        $(".weui-dialog__bd").html("投注金额最低为2");
        $(".errmsgwm").show();
        return false;
    }
    var money=$(".money").html();
    if (zje > Number(money)) {
        $(".weui-dialog__bd").html("您的可用余额不足!");
        $(".errmsgwm").show();
        return false;
    }
        ...
        success: function(m) {
            ...
            if (Number(m[0]['cg']) == 1){
                for (i = 0; i < ml; i++) {
                    ...
                    str += '<div class="col colw1"><span class="green_color">第'+m[i]['qishu']+'期</span><br><span class="green_color">'+m[i]['tid']+'</span></div>';
                    str += '<div class="col colw2"><span class="blue_color">'+m[i]['wf']+'</span><br><span class="red_color">@';
                    str += m[i]['peilv1'];
                    if(Number(m[i]['peilv2'])>1){
                        str += '/'+m[i]['peilv2'];
                    }
                    str += '</span></div>';
                    str += '<div class="col colw3"><span class="red_color">'+m[i]['je']+'</span></div>';
...
function rhtmlbkj(arr) {
      var str = "<a class='sc-1csyyul-1 qiub play p" + arr['pid'] + "' bid='" + arr['bid'] + "' pid='" + arr['pid'] + "' sname='" + arr['sname'] + "' cname='" + arr['cname'] + "' mname='" + arr['name'] + "' maxje='" + arr['maxje'] + "' minje='" + arr['minje'] + "'><div class='b_text sc-1csyyul-0 hokpMe name'>" + qiu(arr['name']) + "</div><div class='b_odds peilv1' style='display: none;'>" + rpeilv(arr['peilv1'], arr['ifok']) + "</div></a>";
    return str;
}
...
function rhtmls(name) {
    return "<div class='bcn_center2 items'><div class='bcn_title'><a class='bt_icon open'></a><div class='game_se' style='display: none;'><select class='SecGame' ><option key='TMA' value='A'>特码A</option> <option key='TMB' value='B'>特码B</option></select></div><span class='namexm'>" + name + "</span></div><div class='ReactCollapse--collapse' style='height: auto;'><div class='ReactCollapse--content'><div class='bcn_number_type'>";
}
//快捷
function rhtmlskj(name) {
    
   return "<div class='bcn_center2 items'><div class='bcn_title'><div class='game_se'><select class='SecGame' ><option key='TMA' value='A'>特码A</option> <option key='TMB' value='B'>特码B</option></select></div><div class='ReactCollapse--collapse' style='height: auto;'><div class='ReactCollapse--content'><div class='bcn_number_type'>";
}
    ...
    switch(fenlei){
        ...
        case '100':
           ...
           /*if($.inArray(ns,sma['紅'])!=-1){
		    ...
		    str = "<div class='qiu100'><div class='odds x"+Number(ns)+"'>"+Number(ns)+"</div>&nbsp;<span>"+sx+"</span></div>"; 
           }else{
           /*if($.inArray(ns,sma['紅'])!=-1){
