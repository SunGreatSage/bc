...
const playTypes = [
  {
    ...
    bullets: ['49 号按号码正常判奖，投注49且特码开49即中奖。'],
    examples: [
  ...
  },
  {
    ...
    bullets: ['生肖表以当年农历顺序为准。', '特码开49按当年生肖正常判奖，不视为和局。'],
    examples: ['特码 08 对应“狗”，投注“狗”即中奖。', '2026 年特码 49 对应“马”，投注“马”即中奖。']
  },
  {
    title: '多生肖组合',
    badge: '组合玩法',
...
const payoutNotes = [
  ...
  '49 号开作特码时，特码号码和特肖按对应号码、对应生肖正常判奖；仅部分特殊选项玩法退还本金。',
...
const faqs = [
  ...
  {
    id: 2,
    question: '哪些玩法开出 49 会和局？',
    answer:
      '49 号在不同玩法里的判奖口径不同，投注前以玩法规则为准：',
    points: [
      '特码号码玩法开49正常判奖，投注49即中奖',
      '特肖开49按当年生肖正常判奖，不视为和局',
      '部分特殊选项玩法开49时，系统自动退回对应投注本金'
    ],
    tip: '退款类玩法的本金会直接充入余额，无需手动申请。'
  },
  {
    id: 3,
    question: '多生肖玩法如何判奖？',
